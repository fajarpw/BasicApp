...
class MainActivity : AppCompatActivity() {
    ...
    protected fun convertUnit(type: String, oriUnit: String?, convUnit: String?, value: Double):
            Double{
    ...
    protected fun strResult(`val`: Double, rounded: Boolean):
            String{
        return if(rounded){
            val f = DecimalFormat("#.##")
            f.format(`val`)
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        unitType!!.setOnCheckedChangeListener{
            ...
            if (selected.text == "Temperature"){
                adapter = ArrayAdapter.createFromResource(unitType!!.context, R.array.tempList, android.R.layout.simple_spinner_item)
                ...
                adapter = ArrayAdapter.createFromResource(unitType!!.context, R.array.distList, android.R.layout.simple_spinner_item)
                imgView!!.setImageResource(R.drawable.distance)
                adapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item)
                unitOri!!.adapter = adapter
                unitConv!!.adapter = adapter
            }else{
                adapter = ArrayAdapter.createFromResource(unitType!!.context, R.array.weightList, android.R.layout.simple_spinner_item)
        ...
        roundBox!!.setOnCheckedChangeListener{
            buttonView, isChecked ->  doConvert()
        }
